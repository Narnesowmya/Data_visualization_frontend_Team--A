...
// Setup mock adapter to handle API endpoints
const mock = new AxiosMockAdapter(apiClient, { delayResponse: 150 });
...
// 2. GET /kpi-stats (Derived directly from filtered events)
...
// 3. GET /analytics (Distribution & Trends derived from filtered events)
...
// 4. PATCH /events/:id (Update event status)
...
// 5. POST /events/simulate (Simulate new incoming real-time security alert)
